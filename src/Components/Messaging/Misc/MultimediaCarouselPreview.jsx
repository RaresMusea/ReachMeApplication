        ...
        <Carousel>
          {type === "images"
            ? resource.map((item, key) => (
                <CarouselImageItem item={item} key={key} />
              ))
            : resource.map((item, key) => (
                <CarouselVideoItem item={item} key={key} />
              ))}
        </Carousel>
      </div>
    </>
...
function CarouselImageItem(props) {
  return (
    <>
      <div>
        <img src={props.item} alt={"Image"} className="CarouselImagePreview" />
      </div>
    </>
  );
}
...
function CarouselVideoItem(props) {
  return (
    <>
      <div>
        <video src={props.item} controls className="CarouselVideoPreview" />
      </div>
    </>
  );
}
