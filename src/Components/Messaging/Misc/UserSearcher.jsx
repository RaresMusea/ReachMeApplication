...
import {
  closeUserSearcher,
  displayUserSearcherInfoAlert,
} from "../../../Modules/Messaging/MessagingModule";
import { useContext, useEffect, useState } from "react";
import {
  foundUsers,
  searchForUsersByIdentity,
} from "../../../Services/Firebase Service/Messaging/UserSearcherService";
import {
    ...
    <>
      <div className="Searcher">
        ...
        {suggestions.map((account) => (
          ...
          >
            <Avatar src={account.profilePhotoHref} className="UserProfilePic" />
            <div className="SearchResultNames">
              <div className="searchUsernameDetails First">
                {account.userName}
              </div>
        ...
        <button className="HideButton" onClick={handleClose}>
          Hide
        </button>
